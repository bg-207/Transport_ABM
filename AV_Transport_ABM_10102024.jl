...
function initialize(; total_agents = 250, gridsize = (20, 20), private_AV_cost = 100000, rh_trip_cost = 10,  av_threshold_model = 5.0, rh_threshold_model = 5.0, AVs = 0, RH_trips = 0, AVs_time_series = [0], # Starting with 0 AVs
    ...
    properties, rng = rng, container = Vector, scheduler = Schedulers.Randomly())
...
#CSV.write("C:/Users/godicb/OneDrive - The University of Melbourne/Documents/Julia/AV_Transport_ABM/AVpromotionpolicy_"*string(random_seeds[i])*".csv", agent_df)
...
function plot_population_timeseries(agent_df)
    ...
    axislegend(ax, [av_agents, auto_rh_agents, car_agents, pt_agents, personal_micromobility_agents, walker_agents, cyclist_agents, rh_agents, carsharing_agents], ["Private AV", "Autonomous ride hail", "Car", "Public transport", "Personal micromobility", "Walking", "Cycling", "Conventional ride hail", "Car sharing"], labelsize = 10, patchsize = (10,10), position = :rt)
    figure
end
